...
def fetch_gold_coinbase():
    try:
        r = requests.get("https://api.coinbase.com/v2/prices/XAU-USD/spot", timeout=10, headers=HEADERS)
...
def fetch_all_prices():
    return {
        ...
        "BTC":    fetch_mexc("BTCUSDT"),
        "ETH":    fetch_mexc("ETHUSDT"),
        "Gold":   fetch_gold_coinbase(),
        "Silver": fetch_silver(),
